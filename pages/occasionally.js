  ...
  return (
    <div>
      ...
      <div className='px-4 my-5 max-w-6xl mx-auto'>
        ...
        <div className='product-detail-container  justify-center grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 items-center' style={{margin:'0px', gap:'20px 0px', marginTop:'0px'}}>
